...
const BlogPost = ({ slug, Keyword, City, State }) => {
            ...
            <section style={styles.section}>
              <div style={styles.imageContainer}>
                <img 
                  ...
                  alt={`google my business seo company bengaluru karnataka india in ${fullLocation}`} 
                  style={styles.image} 
                />
  ...
  <form 
    onSubmit={async (e) => {
      ...
      try {
        const response = await fetch('https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjYwNTY4MDYzMTA0Mzc1MjZhNTUzNDUxMzUi_pc', {
          method: 'POST',
          headers: {
  ...
  >
    <p style={{ marginBottom: "16px" }}>
      Ready to improve your{Keyword} in {fullLocation}?
...
export default function Page() {
  ...
  const slug = "google-my-business-seo-company-bengaluru-karnataka-india-some-city-some-state-india";
  const Keyword = "google my business seo company bengaluru karnataka india";
